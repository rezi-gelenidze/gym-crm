...
public interface TrainingRepository extends JpaRepository<Training, Long> {
    ...
    @Query("""
        SELECT new io.github.rezi_gelenidze.gym_crm.dto.training.TraineeTrainingListItemDto(
            tr.trainingName,
            tr.trainingDate,
    ...
    @Query("""
        SELECT new io.github.rezi_gelenidze.gym_crm.dto.training.TrainerTrainingListItemDto(
            tr.trainingName,
            tr.trainingDate,
            tr.trainingType.trainingTypeId,
            tr.trainingDuration,
